...
Unfortunately, Qualtrics has translated them to numbers. We need to reassign their labels, so that we can more clearly understand what we are working with. To help in the next step, we are going to open the "Use choice text" exported version from Qualtrics. This helps us identify the correct labels for recoding our data.
